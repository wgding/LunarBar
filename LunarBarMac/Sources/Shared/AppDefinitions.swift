...
enum Localized {
  ...
  enum UI {
    ...
    static let menuTitleFirstDayOfWeek = String(localized: "First Day of Week", comment: "[Menu] Section title for the first day of the week")
    static let menuTitleWeekStartsMonday = String(localized: "Monday", comment: "[Menu] Start the week on Monday")
    static let menuTitleWeekStartsSunday = String(localized: "Sunday", comment: "[Menu] Start the week on Sunday")
